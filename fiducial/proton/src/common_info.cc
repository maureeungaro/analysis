...
cpars::cpars(string filename)
{
	...
	for(unsigned int s=0; s<6; s++)
	{
		...
		addinfo += "  R1 A rite: "  + stringify(r1_a_rite[s]);
		addinfo += "  R2 A left: "  + stringify(r2_a_left[s]);
		addinfo += "  R2 A rite: "  + stringify(r2_a_rite[s]);
		addinfo += "  R3 A left: "  + stringify(r3_a_left[s]);
		addinfo += "  R3 A rite: "  + stringify(r3_a_rite[s]);
		addinfo += "  SC A left: "  + stringify(sc_a_left[s]);
		addinfo += "  SC A rite: "  + stringify(sc_a_rite[s]);
		addInfos.push_back(addinfo);
		addinfo  = "   > S" + stringify(s+1);
		...
		addInfos.push_back(addinfo);
		addinfo  = "   > S" + stringify(s+1);
		addinfo += "  R2 D left: "  + stringify(r2_d_left[s]);
		addinfo += "  R2 D rite: "  + stringify(r2_d_rite[s]);
		addinfo += "  R3 D left: "  + stringify(r3_d_left[s]);
		addinfo += "  R3 D rite: "  + stringify(r3_d_rite[s]);
		addInfos.push_back(addinfo);
	}
