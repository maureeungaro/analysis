...
\abstract{This document describes the electron identification for the e1-6 data.
The candidate electrons are all negative time-based tracks that trigger an event.
...
Where needed, the cuts are sector-dependent.}
