...
\begin{figure}[h]
  \centering
		\includegraphics[width=0.46\textwidth]{img/ccm_slice6_fit_sect1.png}
		\includegraphics[width=0.46\textwidth]{img/ccm_slice9_fit_sect1.png}
		\includegraphics[width=0.46\textwidth]{img/ccm_slice11_fit_sect1.png}
		\includegraphics[width=0.46\textwidth]{img/ccm_slice14_fit_sect1.png}
		\includegraphics[width=0.70\textwidth]{img/cc_theta_matching_pars_sect1.png}
