...
public:
    ...
    void show_cc_theta_match_comparison(int sector);
...
private:
    ...
    TH1F *cc_match1d[6][CC_Match::NDIV];      // 1 dimensional projections, fitted with GAUSS+PARABOLE
    double cc_matchmean[6][CC_Match::NDIV];
    double cc_matchsigm[6][CC_Match::NDIV];
    double cc_matchmeane[6][CC_Match::NDIV];
    double cc_matchsigme[6][CC_Match::NDIV];
    ...
    TF1 *cc_match_me = nullptr;
    TF1 *cc_match_up = nullptr;
    TF1 *cc_match_dn = nullptr;
