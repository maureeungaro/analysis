...
\title{\large e1-6 pion electro-production Radiative Correction}
 \author{M. Ungaro, K. Joo}
\maketitle

\abstract{This document describes the radiative correction to the measured pion production
cross section. The {\it exclurad} theoretical framework, developed
at Jefferson Laboratory, has been used. The missing mass cut is discussed. }

\tableofcontents

\include{e16_radcorr}
\include{e16_radcorr_bib}
