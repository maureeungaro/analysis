...
// Usage
// ./e_mom_corr -PARS_FILE=/opt/projects/analysis/e_kin_cor/momentum/emom_corr_pars.txt -ROOT_OUTPUT=corr.root /enkil/e1-6/p_pid/3116*.mu -BEAM_E=5.7542 -TARGET=proton -VERBOSITY=0
